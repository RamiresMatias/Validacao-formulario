...
const confirmaPassword = document.querySelector('.confirmPassword');
...
function checkFormEmptyFields(...inputs) {
    inputs.forEach((input) => {
        if (!input.value)
            showErrorMessage(input, MESSAGE_FIELD_EMPTY);
    });
}
function checkEqualPasswords(password1, confirmPassword) {
